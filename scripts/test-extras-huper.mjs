// Tests de extras manuales + Huper (Angelo/Angel, baja Carlos): node scripts/test-extras-huper.mjs
...
const outFile = path.join(outDir, 'test-extras-huper-core.bundle.mjs')

esbuild.buildSync({
  entryPoints: [path.join(RAIZ, 'scripts', 'test-extras-huper-core.mjs')],
  bundle: true,
  platform: 'node',
  format: 'esm',
