// Tests de la escala de descuentos: node scripts/test-multas.mjs
...
const outFile = path.join(outDir, 'test-multas-core.bundle.mjs')

esbuild.buildSync({
  entryPoints: [path.join(RAIZ, 'scripts', 'test-multas-core.mjs')],
  bundle: true,
  platform: 'node',
  format: 'esm',
