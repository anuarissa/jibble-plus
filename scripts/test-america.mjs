// Tests de Sbarro América (horarios + biométrico): node scripts/test-america.mjs
...
const outFile = path.join(outDir, 'test-america-core.bundle.mjs')

esbuild.buildSync({
  entryPoints: [path.join(RAIZ, 'scripts', 'test-america-core.mjs')],
  bundle: true,
  platform: 'node',
  format: 'esm',
