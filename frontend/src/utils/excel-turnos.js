...
export function descargarTemplateTurnos({ empleados, weekKey, nombreLocal }) {
  ...
  const instrucciones = [
    ...
    [],
    ['DESCUENTOS (todos los locales)'],
    ['  - Tardanza:  1-10 min = 10 Bs · 11-20 min = 20 Bs · 21+ min = 30 Bs (tope).'],
    ['  - No marcar entrada o salida (vino): 40 Bs.'],
    ['  - Faltar al trabajo (día programado sin marcar): 110 Bs, además de no'],
    ['    pagarse esas horas. Vacaciones/permiso se justifican en la app.'],
